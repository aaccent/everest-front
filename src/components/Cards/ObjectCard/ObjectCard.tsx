...
function ActionButton({ className }: ActionButtonProps) {
  return (
    <button
      className={`flex size-[36px] items-center justify-center rounded-full bg-base-600/50 before:size-[20px] before:filter-base-100 before:bg-default md:size-[64px] md:before:size-[24px] ${className}`}
    />
  )
}
    ...
    <Link href='#'>
      <div className='relative mb-[22px]'>
        ...
        <div className='absolute right-[16px] top-[16px] flex gap-[4px] md:right-[14px] md:top-[14px] md:gap-[8px]'>
          ...
          <ActionButton className='before:bg-icon-scale' />
          <ActionButton className='before:bg-icon-address' />
        </div>
      ...
      <div>
        ...
        <span className='flex gap-[4px] before:relative before:top-[1px] before:block before:size-[19px] before:bg-icon-clip before:opacity-50 before:filter-base-600 before:bg-default'>
          5 мин назад
        </span>
      </div>
    </Link>
