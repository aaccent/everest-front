...
function SeeAllCard({ className }: SeeAllCardProps) {
  return (
    <Link
      href='#'
      className={`min-w-0" relative block max-w-[320px] shrink-0 grow-0 basis-full rounded-[20px] bg-base-300 p-[16px] md:max-w-[512px] md:rounded-[32px] md:p-[32px] ${className} `}
    >
