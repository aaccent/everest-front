...
function FilterPopup({ category }: Props) {
  ...
  return (
    <>
      <div className='absolute inset-x-0 bottom-0 flex h-[calc(100dvh-64px)] flex-col rounded-[24px] bg-base-100 md:top-[48px] md:block md:h-full md:overflow-auto md:p-[56px]'>
        <div className='relative h-1 grow p-[24px] md:static md:h-fit md:grow-0'>
        ...
        <div className='bottom-0 left-0 z-10 flex w-full items-center justify-between bg-base-100 px-[24px] py-[16px] md:justify-normal md:border-t md:border-t-base-400 md:px-[56px] md:py-[24px]'>
