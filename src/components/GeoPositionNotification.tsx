...
function GeoPositionNotification({ cityByIp }: Props) {
  ...
  return (
    <div className='fixed inset-x-0 bottom-0 z-50 rounded-t-[24px] bg-base-100 px-[24px] pb-[32px] pt-[24px] md:inset-x-auto md:right-[169px] md:top-[44px] md:h-fit md:w-[320px] md:rounded-b-[24px] md:pb-[24px]'>
