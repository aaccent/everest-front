    ...
    return (
      <ul className='mt-[24px] pb-[24px] flex flex-col gap-[12px] border-b border-b-base-100/10 md:border-none md:mt-0 md:mr-[127px] md:gap-[14px]'>
        {staticMenu.map((item, index) => (
          <Link href={'#'} key={index}>
            <li className='text-base-100 text-base-100-reg-100_mobile md:text-base-100-reg-100_desktop'>{item}</li>
          </Link>
        ))}
      </ul>
    )
  ...
  function showDesktopSocials() {
    return (
      <div className='hidden md:block'>
        <div className='mb-[15px] text-base-100-reg-100_desktop text-base-150'>Соц.сети</div>
        <ul className='flex flex-col gap-[10px]'>
          {socials.map((social, index) => (
            <Link className='flex gap-[10px] items-center' href={social.url} key={index}>
              ...
              <div className='text-base-300-lg-100_desktop text-base-100'>{social.name}</div>
            </Link>
          ))}
        </ul>
      </div>
  ...
  return (
    <Section containerClassName={'py-[32px] footer'} className='bg-base-600 rounded-t-[20px] md:rounded-t-[32px]'>
      <div className='flex flex-col md:pt-[61px] md:flex-row md:pb-[65px] md:border-b md:border-b-base-100/10'>
        <div className='flex justify-between items-end pb-[23px] border-b border-b-base-100/10 md:items-start md:border-none'>
          <div className='max-w-[206px] w-full md:mr-[153px] md:max-w-[243px]'>
            ...
            <div className='mt-[16px] mb-[31px] text-base-400-lg-100_mobile text-base-150 md:mt-[20px] md:mb-[73px] md:text-base-400-lg-100_desktop'>
              Индивидуальный подбор объектов для вашего комфорта
            </div>
            <div className='mb-[2px] text-base-100-reg-100_mobile text-base-100 md:text-base-100-reg-100_desktopb-[4px]'>
              <Link href={'tel:8 (843) 207-39-50'}>8 (843) 207-39-50</Link>
            </div>
            <div className='mb-[12px] text-base-400-lg-100_mobile text-base-150 md:text-base-400-lg-100_desktop md:mb-[16px]'>
              Ежедневно с 09:00 до 19:00
            </div>
            <div className='flex gap-[6px] items-center text-base-100 text-base-200-lg-100_mobile before:bg-icon-email before:bg-no-repeat before:bg-center before:size-[22px] md:text-base-200-lg-100_desktop'>
      ...
      <div className='mt-[23px] md:flex md:items-center'>
        ...
        <div className='mt-[24px] flex flex-col gap-[12px] text-base-150 text-base-500-reg-200_mobile md:mt-0 md:order-2 md:flex-row md:text-base-500-reg-200_desktop'>
