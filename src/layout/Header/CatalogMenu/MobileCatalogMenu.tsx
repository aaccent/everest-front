...
async function MobileCatalogMenu() {
  ...
  return (
    <MobileCatalogMenuWrapper className='invisible fixed inset-0 z-40 opacity-0 transition-opacity after:absolute after:inset-x-0 after:top-full after:z-10 after:h-full after:bg-base-100 peer-[[data-menu="catalog"]]/header-state:visible peer-[[data-menu="catalog"]]/header-state:opacity-100'>
