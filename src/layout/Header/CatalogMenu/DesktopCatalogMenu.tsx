...
async function DesktopCatalogMenu() {
  ...
  return (
    <aside className='px-container invisible fixed inset-x-0 top-0 z-40 flex w-full gap-[16px] rounded-b-[32px] bg-base-100 pb-[56px] pt-[145px] opacity-0 transition-opacity peer-[[data-menu="catalog"]]/header-state:visible peer-[[data-menu="catalog"]]/header-state:opacity-100'>
