...
async function DesktopCatalogMenu() {
  ...
  return (
    <aside className='px-container invisible fixed inset-x-0 top-0 z-20 flex w-full gap-[16px] bg-base-100 pb-[56px] pt-[145px] opacity-0 transition-opacity peer-[.catalog-menu]/style-state:visible peer-[.catalog-menu]/style-state:opacity-100'>
