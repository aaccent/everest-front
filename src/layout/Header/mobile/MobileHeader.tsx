...
function MobileHeader({ className }: Props) {
  return (
    <header
      className={`header px-container fixed left-0 top-0 z-40 flex w-[100%] items-center justify-between pb-[11px] pt-[15px] transition-colors peer-[[data-main-page]]/header-state:!fixed peer-[.is-black]/header-state:sticky peer-[[data-menu="catalog"]]/header-state:hidden peer-[.is-black]/header-state:bg-base-100 peer-[.is-black]/header-state:text-base-600 ${className}`}
    >
