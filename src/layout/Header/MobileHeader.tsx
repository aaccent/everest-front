...
function MobileHeader({ className }: Props) {
  const scrollingStyles =
    'peer-any-parent-[.is-scrolled]/style-state:bg-base-100 peer-any-parent-[.is-scrolled]/style-state:text-base-600'
  ...
  return (
    ...
    >
      <div className='absolute left-0 bottom-0 px-[20px] w-full h-full flex items-end pointer-events-none transition-[padding] peer-any-parent-[.is-scrolled]/style-state:px-0'>
      ...
      <Image
        className='w-[120px] h-[26px] object-contain object-center transition-[filter] peer-any-parent-[.is-scrolled]/style-state:filter-primary'
        src={Logo}
        alt='Логотип компании Эверест'
      />
      <button
        className='circle-[36px] flex flex-col gap-[4px] justify-center items-center bg-base-115 after:size-[20px] after:bg-no-repeat after:bg-center after:bg-icon-phone transition-colors after:transition-colors peer-any-parent-[.is-scrolled]/style-state:bg-base-300 peer-any-parent-[.is-scrolled]/style-state:after:filter-base-600'
        type='button'
        title='Звонок'
      />
    </header>
