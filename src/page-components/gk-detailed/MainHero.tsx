    ...
    >
      ...
      <div className='mt-[33px] bg-transparent md:order-2 md:mt-0 md:w-[644px] md:rounded-[20px] md:bg-base-200'>
        ...
        <div className='md:px-[40px]'>
          ...
          <div className='text-base-200-lg-100 mt-[56px] hidden w-full max-w-[464px] text-base-650 md:block md:pb-[171px]'>
            {description}
          </div>
        </div>
      </div>
      ...
      <div className='items-center gap-[24px] md:absolute md:bottom-[40px] md:right-[242px] md:z-50 md:flex'>
