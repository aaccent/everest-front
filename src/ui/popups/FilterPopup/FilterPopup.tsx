...
function FilterPopup({ objectsAmount, getFilters, categoryCode }: Props) {
  const [filters, setFilters] = useState<{ quick: QuickFilters; general: Filters }>({
    quick: { filters: [], sorts: [] },
  ...
  const link = params.category ? '' : categoryLink
